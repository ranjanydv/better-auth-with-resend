...
export function ShieldSlash({ size = 24 }: { size?: number }) {
    return (
        <svg fill="none" height={size} viewBox="0 0 30 31" width={size} xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <path
                d="M23.2681 19.7904C25.0898 16.4433 26.258 12.0103 25.4952 6.42333C25.4527 6.11182 25.2262 5.83921 24.9037 5.73649C23.7314 5.36313 21.7507 4.75136 19.7948 4.2339C17.795 3.70482 15.9565 3.3125 15.0005 3.3125C14.0444 3.3125 12.2059 3.70482 10.2061 4.2339C9.54756 4.40814 8.88617 4.59307 8.25377 4.77599L6.74362 3.26583C7.66521 2.99032 8.69786 2.69343 9.72655 2.42126C11.6819 1.90392 13.7587 1.4375 15.0005 1.4375C16.2422 1.4375 18.319 1.90392 20.2744 2.42126C22.2736 2.95022 24.2879 3.57255 25.4727 3.94991C26.4615 4.26483 27.2094 5.11764 27.353 6.1697C28.2118 12.4602 26.7926 17.4481 24.6452 21.1674L23.2681 19.7904Z"
                fill="currentColor"
            />
            <path
                clipRule="evenodd"
